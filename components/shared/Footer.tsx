        ...
        <div className="mx-auto max-w-screen-xl">
          <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                <h2 className="mb-6 text-sm font-semibold text-white/80 uppercase">
                  Resources
                </h2>
              ...
              <div>
                <h2 className="mb-6 text-sm font-semibold text-white/80 uppercase dark:text-white">
                  Follow me
                </h2>
                <ul className="text-white/60">
                  <li className="mb-2">
